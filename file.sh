...
[ "x$_local_domain_name" == "x" ] && _local_domain_name=$env_domain_name_file
[ "x$_local_domain_name" == "x" ] && _local_domain_name=file.$env_domain_name
...
echodo ./.miniserve_base.sh ${_local_domain_name} ${DATA_DIR}
